...
namespace Core
{
    public sealed class StoryChapterConfig
    {
        ...
        public List<string> PreludeDialogues = new List<string>();
        public List<string> MiniGameGuideDialogues = new List<string>();
        public MiniGameConfig MiniGame;
        public List<string> PostMiniGameDialogues = new List<string>();
    ...
    {
        public static readonly List<string> PrologueDialogues = new List<string>
        {
        ...
        public static readonly List<string> EndingDialogues = new List<string>
        {
        ...
        private static StoryChapterConfig BuildChapter1()
        {
            return new StoryChapterConfig
            {
                ...
                PreludeDialogues = new List<string>
                {
                    "【生态研究员】我们现在所在的，是淮河干流的湿地保护区。",
                    "【生态研究员】淮河是安徽的母亲河，过去的水污染问题，曾严重影响沿岸生态与居民生活。",
                    "【生态研究员】经过多年的系统治理，淮河水质已经稳定向好，但零星的垃圾污染、油污排放，依然会威胁水生态安全。",
                    "【生态研究员】现在，需要你协助我们完成一次水面应急净化，守护淮河湿地的生态平衡。"
                },
                MiniGameGuideDialogues = new List<string>
                {
                    "【生态研究员】操作很简单：拖拽水面上的污染物，放到右侧的环保回收桶里。",
                    "【生态研究员】注意不要误触水里的鱼虾、水草，它们是湿地生态的重要部分。",
                ...
                MiniGame = new MiniGameConfig
                {
                    ...
                    VictoryCondition = "90 秒内清理≥80%污染物，且无误伤水生生物违规操作",
                    FailureFeedback = "时间结束未达标，弹出【重试挑战】按钮；不扣进度不卡主线",
                    MemoryAdaptationRule = "独立预制体进入章节时加载，通关/退出立即Destroy；结束后执行资源回收",
                    DataIsolationRule = "通关状态仅写入当前激活账户，不跨账户读取或修改",
                    InfiniteRetry = true
                },
                PostMiniGameDialogues = new List<string>
                {
        ...
        private static StoryChapterConfig BuildChapter2()
        {
            return new StoryChapterConfig
            {
                ...
                PreludeDialogues = new List<string>
                {
                    ...
                    "【产业工程师】绿色生产的核心，就是从源头把控，做好资源分类、循环利用，减少浪费与排放。",
                ...
                MiniGameGuideDialogues = new List<string>
                {
                    ...
                    "【产业工程师】60 秒内分拣准确率达到 90% 以上，即可完成任务。",
                    "【系统】是否开始挑战？【开始挑战】按钮"
                },
                MiniGame = new MiniGameConfig
                {
                    ...
                    VictoryCondition = "60 秒内分拣≥50件且准确率≥90%",
        ...
        private static StoryChapterConfig BuildChapter3()
        {
            return new StoryChapterConfig
            {
                ...
                PreludeDialogues = new List<string>
                {
                    ...
                    "【区域协同专员】长三角协同的核心，就是把合适的科创资源、产业优势、城市定位精准匹配，发挥 1+1>3 的效果。",
                ...
                MiniGameGuideDialogues = new List<string>
                {
                    ...
                    "【区域协同专员】90 秒内完成全部 8 组正确匹配，即可完成任务。",
                    "【系统】是否开始挑战？【开始挑战】按钮"
                },
                MiniGame = new MiniGameConfig
                {
                    ...
                    FailureFeedback = "时间结束未完成全部匹配，弹出【重试挑战】按钮；不扣进度不卡主线",
                    MemoryAdaptationRule = "独立预制体进入章节时加载，通关/退出立即Destroy；结束后执行资源回收",
                    DataIsolationRule = "通关状态仅写入当前激活账户，不跨账户读取或修改",
                    InfiniteRetry = true
                },
